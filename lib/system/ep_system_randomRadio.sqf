/**
	ep_system_randomRadio

	FEATURE
	Play random radio chatter for specified side

	RETURNS
	nothing

	USAGE
	[west, 15, { true }] call ep_system_randomRadio

	PARAMETERS
	M|1. side (west, east)
	O|2. sleepBetween (seconds between radio chatter) (default: 10)
	O|3. condition (code that returns true/false to continue playing) (default: { true })
*/
...
private ["_radioSoundsWest", "_radioSoundsEast", "_sounds", "_source"];
