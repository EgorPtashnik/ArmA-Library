...
ArmADocs.register("Constants", {
    ...
    // -----------------------------------------------------------------------
    // Mission Defaults — fallback skill values used by EP_fnc_setAISkill and
    // EP_fnc_missionInit when a matching key is missing from skillParams.
    // -----------------------------------------------------------------------
    "EP_MISSION_DEFAULT_SKILL": {
        group: "Mission Defaults",
        description: "Fallback for the general AI <code>skill</code> value (SKILL key in <code>skillParams</code>).",
        example: "0.5"
    },

    "EP_MISSION_DEFAULT_AIMING_ACCURACY": {
        group: "Mission Defaults",
        description: "Fallback for <code>aimingAccuracy</code> (AIM key in <code>skillParams</code>).",
        example: "0.2"
    },

    "EP_MISSION_DEFAULT_AIMING_SHAKE": {
        group: "Mission Defaults",
        description: "Fallback for <code>aimingShake</code> (AIM_SHAKE key in <code>skillParams</code>).",
        example: "0.2"
    },

    "EP_MISSION_DEFAULT_AIMING_SPEED": {
        group: "Mission Defaults",
        description: "Fallback for <code>aimingSpeed</code> (AIM_SPEED key in <code>skillParams</code>).",
        example: "0.2"
    },

    "EP_MISSION_DEFAULT_SPOT_DISTANCE": {
        group: "Mission Defaults",
        description: "Fallback for <code>spotDistance</code> (SPOT key in <code>skillParams</code>).",
        example: "0.5"
    },

    "EP_MISSION_DEFAULT_SPOT_TIME": {
        group: "Mission Defaults",
        description: "Fallback for <code>spotTime</code> (SPOT_TIME key in <code>skillParams</code>).",
        example: "0.25"
    },

    "EP_MISSION_DEFAULT_COURAGE": {
        group: "Mission Defaults",
        description: "Fallback for <code>courage</code> (COURAGE key in <code>skillParams</code>).",
        example: "1"
    },

    "EP_MISSION_DEFAULT_RELOAD_SPEED": {
        group: "Mission Defaults",
        description: "Fallback for <code>reloadSpeed</code> (RELOAD key in <code>skillParams</code>).",
        example: "0.5"
    },

    "EP_MISSION_DEFAULT_COMMANDING": {
        group: "Mission Defaults",
        description: "Fallback for <code>commanding</code> (COMMAND key in <code>skillParams</code>).",
        example: "0.5"
    },

    "EP_MISSION_DEFAULT_FLEEING": {
        group: "Mission Defaults",
        description: "Fallback for <code>allowFleeing</code> (FLEEING key in <code>skillParams</code>).",
        example: "0"
    },
